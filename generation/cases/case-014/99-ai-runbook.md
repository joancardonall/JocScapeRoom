...
8. Omple `04-evidence/`.
- Desenvolupa `suspect-01/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-02/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-03/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-04/` amb perfil, transfons, coartada i declaracio.
10. Omple `05-solution/`.
11. Exporta el resultat a `06-export/case-014-draft.json`.
12. Nomes quan el cas sigui coherent, converteix-lo a `app/cases/case-014.json`.
