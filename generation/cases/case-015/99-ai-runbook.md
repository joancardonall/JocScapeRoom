...
8. Omple `04-evidence/`.
- Desenvolupa `suspect-01-arnau-bellmunt/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-02-clara-reventos/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-03-damia-llorens/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-04-sofia-delmas/` amb perfil, transfons, coartada i declaracio.
10. Omple `05-solution/`.
11. Exporta el resultat a `06-export/case-015-draft.json`.
12. Nomes quan el cas sigui coherent, converteix-lo a `app/cases/case-015.json`.
