...
8. Omple `04-evidence/`.
- Desenvolupa `suspect-01-clara-rius/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-02-ramon-vilar/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-03-sofia-pujol/` amb perfil, transfons, coartada i declaracio.
- Desenvolupa `suspect-04-nil-muntaner/` amb perfil, transfons, coartada i declaracio.
10. Omple `05-solution/`.
11. Exporta el resultat a `06-export/case-017-draft.json`.
12. Nomes quan el cas sigui coherent, converteix-lo a `app/cases/case-017.json`.
