# CASE-019 - La vil.la dels llimoners

Aquesta carpeta es la base de treball per construir un cas complex abans de convertir-lo al format final `case-019.json`.
